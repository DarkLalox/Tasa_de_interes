            ...
            child: Column(
              children: [
                ...
                Container(
                  width: 580,
                  height: 580,
                  child: isDark ? const _DateConsumo() : const _DateConsumo1(),
                )
              ],
            ),
          ),
...
class _DateConsumo extends StatefulWidget {
  const _DateConsumo({Key? key}) : super(key: key);

  @override
  State<_DateConsumo> createState() => __DateConsumoState();
}

class __DateConsumoState extends State<_DateConsumo> {
  ...
  final _TIMESERIES = 'F022.CON.TIP.Z.NO.Z.M';
  bool loading = true;
...
class _DateConsumo1 extends StatefulWidget {
  const _DateConsumo1({Key? key}) : super(key: key);

  @override
  State<_DateConsumo1> createState() => __DateConsumoState1();
}

class __DateConsumoState1 extends State<_DateConsumo1> {
  final _URL_BANCO_CENTRAL =
      'https://si3.bcentral.cl/SieteRestWS/SieteRestWS.ashx';
